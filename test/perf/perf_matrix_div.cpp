...
int main()
{
	...
	Error += comp_mat2_div_mat2<glm::packed_mat2, glm::aligned_mat2>(Samples);
	
	std::printf("dmat2 / dmat2:\n");
	Error += comp_mat2_div_mat2<glm::packed_dmat2, glm::aligned_dmat2>(Samples);

	std::printf("mat3 / mat3:\n");
	Error += comp_mat3_div_mat3<glm::packed_mat3, glm::aligned_mat3>(Samples);
	
	std::printf("dmat3 / dmat3:\n");
	Error += comp_mat3_div_mat3<glm::packed_dmat3, glm::aligned_dmat3>(Samples);

	std::printf("mat4 / mat4:\n");
	Error += comp_mat4_div_mat4<glm::packed_mat4, glm::aligned_mat4>(Samples);
	
	std::printf("dmat4 / dmat4:\n");
	Error += comp_mat4_div_mat4<glm::packed_dmat4, glm::aligned_dmat4>(Samples);
