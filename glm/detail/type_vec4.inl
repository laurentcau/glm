...
namespace glm {
	...
	{
		_mm_storeu_ps((float*)this, v.data);
	}
	...
	{
		data = _mm_loadu_si128((__m128i*)&v);
	}
	...
	{
		_mm_storeu_si128((__m128i*)this, v.data);
	}
...
#	if (GLM_ARCH & GLM_ARCH_AVX_BIT)
	...
	{
#	if (GLM_ARCH & GLM_ARCH_AVX_BIT)
		_mm256_storeu_pd((double*)this, v.data);
#else
		_mm_storeu_pd((double*)this, v.data.getv(0));
		_mm_storeu_pd(((double*)this) + 2, v.data.getv(1));
#endif
	}
