...
#			endif
	...
	struct convert_splat<L, double, Q, true> {
		...
		struct detailAVX<b, 0>
		{
			...
			{
				vec<L, double, Q> Result;
				__m256d t1 = _mm256_permute2f128_pd((glm_f64vec4)a.data, (glm_f64vec4)a.data, 0x0);
		...
		struct detailAVX<b, 2>
		{
			...
			{
				vec<L, double, Q> Result;
				__m256d t2 = _mm256_permute2f128_pd((glm_f64vec4)a.data, (glm_f64vec4)a.data, 0x11);
