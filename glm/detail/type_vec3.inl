...
//#endif
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<3, double, packed_highp>::vec(const vec<3, double, aligned_highp>& v)
	{
		...
		_mm_store_sd(((double*)this) + 0, _mm256_castpd256_pd128(v.data));
		_mm_store_sd(((double*)this) + 1, _mm256_castpd256_pd128(T1));
		_mm_store_sd(((double*)this) + 2, _mm256_extractf128_pd(v.data, 1));
#else
		_mm_storeu_pd((double*)this, v.data.getv(0));
		_mm_store_sd(((double*)this) + 2, v.data.getv(1));
#endif
	}
