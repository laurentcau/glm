...
namespace detail
{
	...
	*/
	...
	struct _swizzle_base2 : public _swizzle_base1<N, T, Q, E0,E1,E2,E3, detail::use_simd<Q>::value>
	{
		struct op_equal
		{
	...
	template<int N, typename T, qualifier Q, int E0, int E1, int E2, int E3>
	struct _swizzle_base2<N, T, Q, E0,E1,E2,E3, 1> : public _swizzle_base1<N, T, Q, E0,E1,E2,E3, detail::use_simd<Q>::value>
	{
		struct Stub {};
